...
# InvestOS Pattern Summary — 2026-07-22

## Regime Drift
- ✅ Regime stable — no drift signals
- Breadth (200MA): 75.3%  (-0.14%/day)
- Sharpe: 0.159  (-0.012/day)

## Ticker Streaks (appeared 3+ days in picks)
- **BMO.TO** — 6d streak, avg score 97.7
...
- **BANKS**: 50.0% of recent picks (2 picks) — HIGH_CONCENTRATION
- **FINANCIALS**: 50.0% of recent picks (2 picks) — HIGH_CONCENTRATION
...
- 2026-07: n=71  WR=44% ⚠️

---
_Generated by pattern_agent.py · InvestOS v4.2 · 2026-07-22_
