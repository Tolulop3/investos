...
# InvestOS Pattern Summary — 2026-07-24

## Regime Drift
- ✅ Regime stable — no drift signals
- Breadth (200MA): 73.6%  (+0.07%/day)
- Sharpe: 0.096  (-0.017/day)

## Ticker Streaks (appeared 3+ days in picks)
- **BNY** — 5d streak, avg score 100.0
- **BMO.TO** — 4d streak, avg score 97.0
...
- **FINANCIALS**: 100.0% of recent picks (3 picks) — HIGH_CONCENTRATION
...
- 2026-07: n=86  WR=38% ⚠️

---
_Generated by pattern_agent.py · InvestOS v4.2 · 2026-07-24_
