...
def apply_sector_cap(picks, max_per_sector=2, regime=None):
    ...
    Regime-aware: BULL allows more concentration, BEAR forces more diversification.
      BULL:    max 3 per sector (35% tolerance)
      NORMAL:  max 2 per sector (default)
      CAUTION: max 2 per sector
      BEAR:    max 1 per sector (15% — preserve capital, don't double up on anything)

    Keeps the highest-scored pick in each sector when over limit.
    Returns filtered list with sector counts noted.
    """
    # Auto-detect regime from CONFIG if not passed in
    if regime is None:
        try:
    ...
    SECTOR_MAP = {
        ...
        "MSFT":"TECH","AAPL":"TECH","GOOGL":"TECH","META":"TECH","AMZN":"TECH",
        "CRWD":"TECH","PANW":"TECH","ZS":"TECH","DDOG":"TECH","SNOW":"TECH","MDB":"TECH",
        "OTEX.TO":"TECH","BB.TO":"TECH","DSG.TO":"TECH",
        # Telecom
        "T.TO":"TELECOM","BCE.TO":"TELECOM","RCI-B.TO":"TELECOM","VZ":"TELECOM",
        # ETFs
        "XGRO.TO":"ETF","XEQT.TO":"ETF","VFV.TO":"ETF","ZCN.TO":"ETF","XIU.TO":"ETF",
        "XIC.TO":"ETF","VOO":"ETF","VTI":"ETF","QQQ":"ETF","SPY":"ETF","VEA":"ETF","VWO":"ETF",
        "SCHD":"ETF","VYM":"ETF","DVY":"ETF","HDV":"ETF","DGRO":"ETF",
        # Consumer
        "ATD.TO":"CONSUMER","MRU.TO":"CONSUMER","L.TO":"CONSUMER","DOL.TO":"CONSUMER",
        "WMT":"CONSUMER","TGT":"CONSUMER","SBUX":"CONSUMER","CMG":"CONSUMER","NKE":"CONSUMER",
        "LULU":"CONSUMER","MCD":"CONSUMER","KO":"CONSUMER","PEP":"CONSUMER",
        # Infrastructure
        ...
        "ISRG":"HEALTHCARE","DXCM":"HEALTHCARE","VEEV":"HEALTHCARE","HIMS":"HEALTHCARE",
        # Financials
